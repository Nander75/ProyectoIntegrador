...
public class Test1 extends JFrame {
	...
	public final static String ACT_CMN_BTN_FINALIZAR = "Finalizar";
	...
	private void colocarComponentes() {
		...
		opc1_2.setFont(new Font("Tahoma", Font.BOLD, 11));
		opc1_2.setBackground(new Color(84, 90, 246));
		opc1_2.setBounds(204, 106, 65, 23);
		getContentPane().add(opc1_2);
		
		// Pregunta 2
		JLabel lblPregunta2 = new JLabel("2. ¿Cuál es el método principal en una aplicación Java?");
		...
		opc2_2.setFont(new Font("Tahoma", Font.BOLD, 11));
		opc2_2.setBackground(new Color(84, 90, 246));
		opc2_2.setBounds(204, 175, 85, 23);
		getContentPane().add(opc2_2);
		
		// Pregunta 3
		JLabel lblPregunta3 = new JLabel("3. ¿Cómo se declara una variable de texto en Java?");
		...
		opc3.setFont(new Font("Tahoma", Font.BOLD, 11));
		...
		opc3_1.setFont(new Font("Tahoma", Font.BOLD, 11));
		...
		opc3_2.setFont(new Font("Tahoma", Font.BOLD, 11));
		opc3_2.setBackground(new Color(84, 90, 246));
		opc3_2.setBounds(370, 246, 143, 23);
		getContentPane().add(opc3_2);
		
		// Pregunta 4
		JLabel lblPregunta4 = new JLabel("4. ¿Qué palabra clave se usa para crear un objeto en Java?");
		...
		opc4_2.setFont(new Font("Tahoma", Font.BOLD, 11));
		opc4_2.setBackground(new Color(84, 90, 246));
		opc4_2.setBounds(204, 307, 75, 23);
		getContentPane().add(opc4_2);
		
		// Pregunta 5
		JLabel lblPregunta5 = new JLabel("5. ¿Cuál es el operador de asignación en Java?");
		...
		// Pregunta 10
		JLabel lblPregunta10 = new JLabel("10. El método main debe ser declarado como public static void en Java.");
