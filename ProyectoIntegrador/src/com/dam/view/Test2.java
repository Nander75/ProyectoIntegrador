...
public class Test2 extends JFrame {
    ...
    private void colocarComponentes() {
        ...
        opc1 = new JCheckBox("Una estructura de control que repite un bloque de c�digo un n�mero fijo de veces.");
        opc1.setBackground(new Color(84, 90, 246));
        opc1.setBounds(44, 106, 500, 23);
        getContentPane().add(opc1);
        
        opc1_1 = new JCheckBox("Una instrucción que solo se ejecuta si se cumple una condici�n.");
        ...
        lblPregunta3.setBounds(27, 275, 389, 14);
     ...
     // Pregunta 4
        ...
        opc4 = new JCheckBox("Un método que se llama autom�ticamente cuando se crea un objeto.");
